...
\hypersetup{
 pdfauthor={Theodore Kaczynski, Simon Nikolai Varøy},
 pdftitle={Det industrielle samfunn og dets fremtid},
 pdfkeywords={},
 pdfsubject={},
 pdfcreator={Emacs 29.1 (Org mode 9.7)}, 
 pdflang={Norwegian Bokmål}}
\begin{document}
...
\label{sec:org20e4da6}
\section*{1.}
\label{sec:org0df97a2}
...
i \guillemotleft{}utviklede\guillemotright{} land, men den har destabilisert samfunnet, gjort livet
...
uro, psykologisk lidelse og muligens mer fysisk lidelse selv i \guillemotleft{}utviklede\guillemotright{}
land.
\section*{2.}
\label{sec:org0b1bf41}
...
\label{sec:org6cd85d9}
\section*{6.}
\label{sec:orgec26f66}
...
det meste på sosialister, kollektivister, \guillemotleft{}politisk korrekte\guillemotright{} typer,
...
relaterte typer. Derfor vil det vi mener med \guillemotleft{}venstrevridd ideologi\guillemotright{} komme
frem tydeligere i løpet av vår diskusjon om venstrevridd psykologi. (Se avsnitt
227--30.)
\section*{8.}
\label{sec:org3c38d62}
...
åpent.
\section*{9.}
\label{sec:org3099a1e}
De to psykologiske tendensene som underligger moderne venstrevridd ideologi
kaller vi \guillemotleft{}følelser av underlegenhet\guillemotright{} og \guillemotleft{}oversosialisering\guillemotright{}. Følelser av
...
\label{sec:orge79d33e}

\section*{10.}
\label{sec:org0ad4500}
Med \guillemotleft{}følelser av underlegenhet\guillemotright{} tenker vi ikke bare på disse følelsene i en
...
Ordene \guillemotleft{}neger\guillemotright{}, \guillemotleft{}orientalsk\guillemotright{}, \guillemotleft{}handikappet\guillemotright{} eller \guillemotleft{}høne\guillemotright{} for en
afrikaner, asiater, funksjonshemmet person eller kvinne hadde historisk ingen
støtende konnotasjon. \guillemotleft{}Berte\guillemotright{} eller \guillemotleft{}høne\guillemotright{} var bare de feminine versjonene
av \guillemotleft{}fyr\guillemotright{}, \guillemotleft{}type\guillemotright{} eller \guillemotleft{}gubbe\guillemotright{}. De negative konnotasjonene har blitt
tillagt disse ordene av aktivistene selv. Noen dyrerettsaktivister har gått så
lang som å avvise bruken av ordet \guillemotleft{}kjæledyr\guillemotright{} og insisterer på at det skal
erstattes med \guillemotleft{}dyrefølgesvenn\guillemotright{}. Venstrelente antropologer strekker seg langt
for å ikke si noe om primitive kulturer som kan tolkes som negativt. De ønsker
å erstatte ordet \guillemotleft{}primitiv\guillemotright{} med \guillemotleft{}analfabet\guillemotright{}. De virker nesten paranoide når
...
\section*{12.}
\label{sec:orgb8ac2d2}
De som er mest sensitive når det gjelder \guillemotleft{}politisk ukorrekt\guillemotright{} ordbruk er ikke
...
aktivister som i mange tilfeller ikke engang tilhører en \guillemotleft{}undertrykt\guillemotright{} gruppe.
...
\section*{16.}
\label{sec:org646d88a}
Ord som \guillemotleft{}selvsikkerhet\guillemotright{}, \guillemotleft{}selvstendighet\guillemotright{}, \guillemotleft{}initiativ\guillemotright{},
\guillemotleft{}foretaksomhet\guillemotright{}, \guillemotleft{}optimisme\guillemotright{} osv. spiller en liten rolle i liberal og
...
Om en person er \guillemotleft{}underlegen\guillemotright{} er det derfor ikke hans feil, men heller
samfunnets feil, fordi han ikke ble oppdratt på en god måte.
\section*{19.}
\label{sec:orgb976464}
...
uønskelige oppførsel.\footnote{Vi hevder ikke at alle, eller engang de fleste, mobbere lider av følelser
av underlegenhet.} Men den venstrevridde har gått for
...
\label{sec:org4d3736e}
\section*{24.}
\label{sec:orgc075ceb}
Psykologer bruker begrepet \guillemotleft{}sosialisering\guillemotright{} for å beskrive prosessen der barn
...
realiteten ikke har et moralsk opphav. Vi bruker begrepet \guillemotleft{}oversosialisert\guillemotright{}
for a beskrive slike mennesker.\footnote{Under viktoriatiden led mange mennesker av psykologiske problemer som kom
...
\guillemotleft{}skitne\guillemotright{} tanker. Og sosialisering er ikke bare et spørsmål om moral; vi
...
intellektuelle ved universiteter\footnote{Spesialister innenfor ingeniørfag eller \guillemotleft{}seriøs\guillemotright{} vitenskap er ikke
nødvendigvis inkludert her.} er den mest
sosialiserte, og også den mest venstrevridde delen av samfunnet.
\section*{28.}
\label{sec:org1b3fb08}
...
øvre klasser\footnote{Det er mange individer i middel og øvre klasser som motsetter seg noen av
...
kunne vært nyttig for systemet. Fattigdom må \guillemotleft{}kureres\guillemotright{} fordi underklassen
...
selvstendige.)}) lenge. Disse verdiene er eksplisitt eller implisitt uttrykt
...
for slike skoler; den svarte \guillemotleft{}underklassens\guillemotright{} levemåte ser de på som en skam.
...
\guillemotleft{}ansvarlige\guillemotright{}, svarte gjenger ikkevoldelige osv. Men dette er det
...
jobb, klatrer karrierestigen, er en \guillemotleft{}ansvarlig\guillemotright{} forelder, er ikkevoldelig
...
deres egne ord, er vold for dem en form for \guillemotleft{}frigjøring\guillemotright{}. Med andre ord, ved
...
\label{sec:org12b1e16}
\section*{33.}
\label{sec:org0cad0b6}
...
\label{sec:orgc313835}
\section*{38.}
\label{sec:orga986c7e}
...
\section*{39.}
\label{sec:orga64c5bf}
Vi bruker begrepet \guillemotleft{}erstatningsaktivitet\guillemotright{} for å beskrive en aktivitet som
gjøres for å nå et abstrakt mål som folk setter for seg selv bare for å ha et
mål å jobbe mot, eller la oss si, bare for \guillemotleft{}tilfredsstillelsen\guillemotright{} de får ved å
...
enig i at \guillemotleft{}tilfredsstillelsen\guillemotright{} de får av jobben er viktigere enn pengene og
prestisjen de får.
\section*{41.}
\label{sec:orga9ac329}
...
aktivitetene enn de får fra den \guillemotleft{}kjedelige\guillemotright{} jobben med å tilfredsstille sine
...
\chapter{Autonomi}
\label{sec:org24d9fd9}
\section*{42.}
\label{sec:orga7949b4}
...
individ er ubetydelig.\footnote{Det kan kanskje argumenteres for at flertallet av mennesker ikke ønsker å
...
\label{sec:org2ac0244}
\section*{45.}
\label{sec:org8e291eb}
...
personlig lojalitet foran lojaliteten til systemet, og det er \guillemotleft{}nepotisme\guillemotright{}
eller \guillemotleft{}diskriminering\guillemotright{}, som begge er store synder i det moderne samfunn.
...
kastrerte, tamme og gjort om til systemets verktøy.\footnote{Et delvis unntak kan gjøres for et par passive og innadvendte grupper
...
Ungdomsgjenger og \guillemotleft{}kulter\guillemotright{} er to eksempler. Alle ser på dem som farlige, og det
...
vitnesbyrd som \guillemotleft{}beviser\guillemotright{} deres uskyld. Systemet ville åpenbart fått mange
...
nødvendigheten av å bryte ned småskala sosiale grupper slik som familien: \guillemotleft{}
(Ifølge Sun Yat-sen) trengte kineserne en ny bølge av patriotisme, som ville
overføre lojalitet fra familien til systemet\ldots{} (Ifølge Li Huang) måtte
tradisjonelle koblinger, særlig familien, forlates om nasjonalisme skulle
utvikle seg i Kina. \guillemotright{} (Chester C. Tan, \guillemotleft{}Chinese Political Thought in the
Twentieth Century, \guillemotright{} side 125 og 297.)}
\section*{53.}
\label{sec:orgd008b84}
...
tone. Veldig ulikt dagens samfunn.\footnote{Ja, vi er klar over at Amerika på 1800-tallet hadde sine problemer, og
virkelig seriøse problemer, men for å være kortfattet må vi forklare oss på en
forenklet måte.}
\section*{57.}
\label{sec:orgdacc1de}
...
\label{sec:orgc412d60}
\section*{59.}
\label{sec:org781bcbd}
...
tendens til å garantere fysiske behov til alle\footnote{Vi legger \guillemotleft{}underklassen\guillemotright{} til side. Vi snakker om den generelle
befolkningen.} i bytte
...
\guillemotleft{}minimal\guillemotright{}, men som regel er kravene som stilles til jobber på lavere til
...
blir tilfredsstilt.)
\section*{62.}
\label{sec:orgd57b5ad}
Sosiale behov, slik som sex, kjærlighet og status, vil ofte bli i den andre
gruppen i det moderne samfunn, avhengig av individets situasjon.\footnote{Noen samfunnsvitere, lærere, profesjonelle innen \guillemotleft{}mental helse\guillemotright{} og
lignende prøver sitt beste på å dytte de sosiale motivene inn i den første
gruppen ved å prøve å se til at alle har et tilfredsstillende sosialt liv.} Men unntatt
...
for noen år siden som var ærlig nok til å fortelle han, \guillemotleft{}Vår jobb er å få folk
til å kjøpe ting de ikke vil ha og ikke trenger\guillemotright{}. Han forklarte så hvordan en
...
(Denne meningsløsheten blir ofte kalt andre ting slik som \guillemotleft{}normløshet\guillemotright{} eller
\guillemotleft{}tomhet\guillemotright{}). Vi antyder at den såkalte \guillemotleft{}identitetskrisen\guillemotright{} egentlig er søken
...
av våpen legger det aspektet av sikkerhet i deres egne hender.} Søken etter \guillemotleft{}tilfredsstillelse\guillemotright{} er veldig utbredt i det
