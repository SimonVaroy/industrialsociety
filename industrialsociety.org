#+title: Det industrielle samfunn og dets fremtid
...
** 66.
I dag lever mennesker i større grad basert på hva systemet gjør /for/ dem eller
/til/ dem enn basert på hva de gjør for seg selv. Og det de gjør for seg selv,
gjøres i større og større grad gjennom kanaler som systemet har laget.
Muligheter har en tendens til å være dem som systemet gir deg, mulighetene må
tas i samsvar meg regler og reguleringer[fn:13] og teknikker som anbefales av
eksperter må følges om det skal være en sjanse for suksess.
...
[fn:13] Konservatives innsats for å redusere mengden med statlig regulering er
av liten fordel for den gjennomsnittslige personen. For det første kan bare en
brøkdel av reguleringene fjernes fordi de fleste reguleringer er nødvendige. Et
annet poeng er at det meste av reguleringer påvirker bedrifter fremfor den
gjennomsnittslige personen, slik at hovedeffekten blir at makt overføres fra
staten til private selskaper. Det dette betyr for den gjennomsnittslige
personen, er at innblandingen i livet hans fra staten blir erstattet med
innblanding fra store selskaper, som for eksempel kan tillate at kjemikalier
dumpes i vannforsyningen og gi han kreft. De konservative ser på den
gjennomsnittslige personen som et fjols, og bruker sinnet hans mot staten til å
fremme makten til store selskaper.
